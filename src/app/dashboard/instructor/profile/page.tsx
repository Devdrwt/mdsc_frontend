  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <Loader className="h-12 w-12 text-mdsc-gold animate-spin" />
      </div>
    );
  }
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-sm text-amber-700">
                Veuillez mettre à jour vos informations personnelles. Une fois les modifications enregistrées, vous serez redirigé.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="text-center mb-6">
              <div className="relative inline-block">
                <div className="relative w-32 h-32 mx-auto mb-4">
                  {profilePhoto ? (
                    <img
                      src={profilePhoto}
                      alt="Photo de profil"
                      className="w-full h-full rounded-full object-cover border-4 border-mdsc-gold shadow-lg"
                    />
                  ) : (
                    <div className="w-full h-full rounded-full bg-gradient-to-br from-mdsc-gold to-yellow-600 flex items-center justify-center border-4 border-gray-200 shadow-lg">
                ...
                <label
                  ...
                  className="inline-flex items-center px-4 py-2 bg-mdsc-gold text-white rounded-lg hover:bg-yellow-600 transition-all duration-200 cursor-pointer shadow-md hover:shadow-lg transform hover:scale-105"
                >
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center">
                <div className="p-2 bg-mdsc-gold/10 rounded-lg mr-3">
                  <User className="h-5 w-5 text-mdsc-gold" />
                </div>
                <div>
              ...
              {!isEditing && (
                <button
                  ...
                  className="inline-flex items-center px-4 py-2 text-sm font-medium text-mdsc-gold bg-mdsc-gold/10 rounded-lg hover:bg-mdsc-gold/20 transition-colors"
                >
            ...
            {!isEditing ? (
                  ...
                  {formData.website && (
                    <div className="space-y-1">
                      ...
                      <a 
                        ...
                        className="text-mdsc-gold hover:underline"
                      >
                        {formData.website}
                      </a>
                    </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-mdsc-gold focus:border-transparent transition-all"
                      required
                    />
                  </div>
                  <div>
                ...
                <div className="flex justify-end space-x-3 pt-4 border-t border-gray-200">
                  ...
                  <button
                    type="submit"
                    className="inline-flex items-center px-5 py-2.5 bg-mdsc-gold text-white rounded-lg hover:bg-yellow-600 transition-colors font-medium shadow-md hover:shadow-lg"
                  >
            ...
            {identityDocument ? (
                ...
                <div className="flex items-start justify-between flex-wrap gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center px-4 py-2 text-sm font-medium text-mdsc-gold bg-white border border-mdsc-gold rounded-lg hover:bg-mdsc-gold hover:text-white transition-colors"
                    >
                    ...
                    <label
                      ...
                      className="inline-flex items-center px-4 py-2 text-sm font-medium bg-white text-mdsc-gold border border-mdsc-gold rounded-lg hover:bg-mdsc-gold hover:text-white transition-colors cursor-pointer"
                    >
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                ...
                <label
                  ...
                  className="inline-flex items-center px-5 py-2.5 bg-mdsc-gold text-white rounded-lg hover:bg-yellow-600 transition-colors cursor-pointer font-medium shadow-md hover:shadow-lg"
                >
                  <Upload className="h-4 w-4 mr-2" />
