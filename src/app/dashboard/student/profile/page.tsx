                  ...
                  <div className="flex items-center justify-between flex-wrap gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <label
                        ...
                        className="inline-flex items-center px-4 py-2 bg-white text-mdsc-blue-primary border border-mdsc-blue-primary rounded-lg hover:bg-mdsc-blue-primary hover:text-white transition-colors cursor-pointer text-sm font-medium"
                      >
