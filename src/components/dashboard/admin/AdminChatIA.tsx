...
export default function AdminChatIA({ courseId, moduleId }: AdminChatIAProps) {
  ...
  useEffect(() => {
    ...
    const welcomeMessage: ChatMessage = {
      id: 'welcome',
      role: 'assistant',
      content: `Bonjour ${adminName} ! 👑 Je suis votre assistant IA administrateur. Je peux vous aider à gérer la plateforme, analyser les données système, surveiller les performances, modérer le contenu et optimiser les ressources. Comment puis-je vous aider aujourd'hui ?`,
      timestamp: new Date(),
      context,
    };
