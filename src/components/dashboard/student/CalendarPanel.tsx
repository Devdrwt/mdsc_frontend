          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition-colors ${
                viewMode === 'month'
                  ? 'bg-gradient-to-br from-mdsc-blue-primary via-mdsc-blue-dark to-mdsc-blue-primary text-white'
            ...
            <button
              ...
              className="px-4 py-2 bg-gradient-to-br from-mdsc-blue-primary via-mdsc-blue-dark to-mdsc-blue-primary text-white rounded-lg hover:bg-blue-600 transition-colors"
            >
              Aujourd'hui
            </button>
          </div>
        ...
        <div className="lg:col-span-2 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-7 gap-2">
            {days.map((day, index) => {
              ...
              const todayClass = isToday(day) ? 'bg-gradient-to-br from-mdsc-blue-primary via-mdsc-blue-dark to-mdsc-blue-primary text-white font-bold' : 'text-gray-700 hover:bg-gray-500';
